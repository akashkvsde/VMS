...
@Component({
  selector: 'app-end-movement-manager',
  templateUrl: './end-movement-manager.component.html',
  styleUrls: ['./end-movement-manager.component.css']
})
export class EndMovementManagerComponent implements OnInit {
